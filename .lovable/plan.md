...
- Three small "pillar" chips below: *Systems thinking · User empathy · Calm clarity* — visually tying logistics, customer service, and yoga
...
- Resume PDF: a placeholder `Brenda-Angarolla-Resume.pdf` placed in `public/` so the download button works immediately; user can swap the file later
